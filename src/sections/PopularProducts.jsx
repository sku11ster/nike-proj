  ...
  return (
    <section id="products" className="max-container max-sm:mt-2">
      <div className="flex flex-col gap-5">
        ...
        <p className="lg:max-w-lg mt-2 font-montserrat text-slate-gray">Experience the top-notch quality and style with our sought-after selections. Discover a world of
          comfort,design and value.
        </p>
      </div>
      <div className="mt-4 item grid lg:grid-cols-4 md:grid-cols-3 sm:grid-cols-2 grid-cols-1 sm:gap-4 gap-14">
